...
ESP32-based kitchen scale using an HX711 load cell amplifier. Publishes weight readings over MQTT and is designed to be monitored and controlled via **Ignition** (or any MQTT-capable SCADA/HMI).
